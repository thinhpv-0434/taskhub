...
from ...core.permissions import ensure_workspace_access
from ...db.models import User
from ...schemas.workspace import WorkspaceCreate, WorkspaceMemberCreate, WorkspaceRead, WorkspaceRole
...
async def get_workspace(
    ...
    ensure_workspace_access(workspace, current_user)
    return WorkspaceRead.model_validate(workspace)
...
async def add_workspace_member(
    ...
    if not workspace:
        raise NotFoundException(detail="Workspace not found")
    ensure_workspace_access(workspace, current_user, (WorkspaceRole.OWNER,))
